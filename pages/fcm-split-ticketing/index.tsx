          ...
          <div className={styles.projectDetailContainer}>
            ...
            <div>
              ...
              <div className="col-md-12 mt-2">
                <Image
                  className="image"
                  src={`/../public/fc-final-design-implementation-1.png`}
                  alt={"number one"}
                  fill
                />
              </div>
              ...
              <div className="col-md-12 mt-2">
                <Image
                  className="image"
                  src={`/../public/fc-final-design-implementation-2.png`}
                  alt={"number one"}
                  fill
                />
              </div>
              ...
              <div className="col-md-12 mt-2">
                <Image
                  className="image"
                  src={`/../public/fc-final-design-implementation-3.png`}
                  alt={"number one"}
                  fill
                />
              </div>
            ...
            <div>
              ...
              <div className="row gx-5 mt-5">
                <div className="col-md-6">
                  <Image
                    className="image"
                    src={`/../public/google-flights-comparison.png`}
              ...
              <div className="row gx-5 mt-5">
                <div className="col-md-6">
                  <Image
                    className="image"
                    src={`/../public/navan-comparison.png`}
                    alt={"Navan example"}
                    fill
                  />
                </div>
            ...
            <div>
              ...
              <div className="col-md-12 mt-5">
                <Image
                  className="image"
                  src={`/../public/fc-initial-design-review.png`}
                  alt={"number one"}
                  fill
                />
              </div>
              ...
              <div className={`mb-4 ${styles.improvementSectionContainer}`}>
                ...
                <div className="col-md-12 mt-4">
                  <Image
                    className="image"
                    src={`/../public/fc-improvement-1.png`}
                    alt={"number one"}
                    fill
                  />
                </div>
              ...
              <div className={`mb-4 ${styles.improvementSectionContainer}`}>
                ...
                <div className="col-md-12 mt-4">
                  <Image
                    className="image"
                    src={`/../public/fc-improvement-2.png`}
                    alt={"number one"}
                    fill
                  />
                </div>
              ...
              <div className={styles.improvementSectionContainer}>
                ...
                <div className="col-md-9 mt-4">
                  <Image
                    className="image"
                    src={`/../public/fc-improvement-3.png`}
                    alt={"number one"}
                    fill
                  />
                </div>
            ...
            <div>
              ...
              <div className="row gx-5 mt-5">
                <div className="col-md-2">
                  <Image
                    className="image"
                    src={`/../public/fc-design-validation.png`}
              ...
              <div className="row gx-5">
                <div className="col-md-6">
                  <Image
                    className="image"
                    src={`/../public/fc-design-validation-2.png`}
